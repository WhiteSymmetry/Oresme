...
To report a bug, first make sure there isn't already an open [GitHub Issue](https://github.com/WhiteSymmetry/Oresme/issues)
...
* The oresme version you are using.
* Detailed steps to reproduce the bug.
* A tag, if appropriate (_e.g._, "bug" or "enhancement").

### Fix Open Issues

Look through the [GitHub Issues](https://github.com/WhiteSymmetry/Oresme/issues) for any
...
Ready to contribute? Here's how to set up oresme for local development.
...
2. Create your own fork of the oresme [repository](https://github.com/WhiteSymmetry/Oresme).
...
Please note that the oresme project is released with a
