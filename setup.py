...
def get_version():
    with open('src/oresme/__init__.py', 'r', encoding='utf-8') as f:
        content = f.read()
...
setup(
    ...
    package_data={
        "oresme": ["__init__.py", "_version.py", "*.pyi"]
    },
    ...
    keywords="oresme",
    project_urls={
        "Documentation": "https://github.com/WhiteSymmetry/oresme",
        "Source": "https://github.com/WhiteSymmetry/oresme",
        "Tracker": "https://github.com/WhiteSymmetry/oresme/issues",
    },
)
